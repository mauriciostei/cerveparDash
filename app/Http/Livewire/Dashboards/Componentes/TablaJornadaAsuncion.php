...
class TablaJornadaAsuncion extends Component
{
    ...
    public function exportar(){
        $columns = array('Centro', 'Viaje', 'Fecha', 'Chofer', 'Movil', 'Corresponde', 'Hora', 'T. Espera', 'Control 1', 'T. Atendimiento', 'Permanencia');
    ...
    {
        $this->getInfo();
        return view('livewire.dashboards.componentes.tabla-jornada-asuncion');
    }
}
